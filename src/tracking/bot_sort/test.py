...
from src.tracking.bot_sort.config import DEFAULT_CONFIG_PATH, load_experiment_config
from src.tracking.bot_sort.model import run_bot_sort_on_sequence
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate YOLO11n + BoT-SORT on DanceTrack val.")
