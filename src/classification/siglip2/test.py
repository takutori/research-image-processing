...
from src.classification.siglip2.config import DEFAULT_CONFIG_PATH, load_experiment_config
from src.classification.siglip2.train import evaluate_checkpoint


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate best SigLIP 2 checkpoint from config.")
