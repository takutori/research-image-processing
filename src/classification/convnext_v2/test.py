...
from src.classification.convnext_v2.config import DEFAULT_CONFIG_PATH, load_experiment_config
from src.classification.convnext_v2.train import evaluate_checkpoint


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate best ConvNeXt V2 checkpoint from config.")
